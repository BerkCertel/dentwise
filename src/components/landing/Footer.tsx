    ...
    <footer className="px-6 py-12 border-t bg-muted/30">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a href="#how-its-works" className="hover:text-foreground">
                  How it works
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a href="#help-center" className="hover:text-foreground">
                  Help center
                </a>
              </li>
              <li>
        ...
        <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>
            &copy; {new Date().getFullYear()} DentWise. Built for real people
            with real dental questions.
          </p>
        </div>
      </div>
    </footer>
