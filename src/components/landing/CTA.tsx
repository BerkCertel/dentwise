...
function CTA() {
  return (
    <section className="relative py-20 px-6 overflow-hidden bg-gradient-to-br from-muted/10 via-background to-muted/5">
      <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0 pointer-events-none z-0">
        <span className="absolute -left-6 md:left-26 top-24 lg:top-28 w-24 h-24 rotate-90 skew-x-12 rounded-3xl opacity-60 lg:opacity-95 bg-gradient-to-r from-teal-600 to-violet-400 blur-xl"></span>
        <span className="absolute right-4 bottom-12 w-24 h-24 rounded-3xl bg-primary blur-xl opacity-80"></span>
        <span className="absolute -left-36 bottom-8 w-24 h-24 rounded-3xl bg-primary blur-xl opacity-80"></span>
        {/* Yeni efekt eklemek için örnek: */}
        <span className="absolute top-1/2 left-1/4 w-32 h-32 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 blur-2xl opacity-60"></span>
      </div>
