  ...
  return (
    <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-b from-background to-muted/20">
      <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0">
        <span className="absolute -left-6 md:left-26 top-24 lg:top-28 w-24 h-24 rotate-90 skew-x-12 rounded-3xl opacity-60 lg:opacity-95 lg:block bg-gradient-to-r from-teal-600 to-violet-400 blur-xl hidden"></span>
        <span className="absolute right-4 bottom-12 w-24 h-24 rounded-3xl bg-primary blur-xl opacity-80"></span>
        <span className="absolute -left-36  bottom-56 w-24 h-24 rounded-3xl bg-primary blur-xl opacity-80"></span>
      </div>
